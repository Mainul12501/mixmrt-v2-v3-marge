...
class CompanyController extends Controller
{
    ...
    public function change_dwm_status(DisbursementWithdrawalMethod $disbursementWithdrawalMethod, $status)
    {
//        $disbursementWithdrawalMethod = DisbursementWithdrawalMethod::find($id);
        $disbursementWithdrawalMethod->pending_status = $status;

<div class="row">
    <div class="col-lg-12 text-center "><h1 >{{ translate('Company_list') }}</h1></div>
    <div class="col-lg-12">
    ...
    <table>
        ...
        <tr>
            ...
            <th>{{ translate('Total_Company') }} - {{ $data['data']->count() ?? translate('N/A') }} </th>
            <th></th>
            <th></th>
            <th> {{ translate('Active_Company') }} - {{ $data['data']->where('status',1)->count() ?? translate('N/A') }} </th>
            <th></th>
            <th></th>
            <th> {{ translate('Inactive_Company') }} - {{ $data['data']->where('status',0)->count() ?? translate('N/A') }} </th>
            <th></th>
            <th></th>

            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="col-md-8 mt-2">
                        ...
                        <h6>{{translate('messages.cash_in_hand')}} : {{\App\CentralLogics\Helpers::format_currency($account_transaction->from_type == 'store' ? ($account_transaction->store ? $account_transaction->store->vendor->wallet->collected_cash : 0): ($account_transaction->deliveryman ? $account_transaction->deliveryman->collected_cash : 0))}}</h6>
                    </div>
                </div>
            </div>
        </div>

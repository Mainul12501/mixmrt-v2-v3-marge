...
@section('title',translate('messages.add_courier_company'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{translate('messages.add_new_courier_company')}}
                </span>
            </h1>
        </div>
        ...
        @php($defaultLang = 'en')
        <!-- End Page Header -->
        <form action="{{route('admin.company.store')}}" method="post" enctype="multipart/form-data" class="js-validate" id="vendor_form">
            @csrf
                            ...
                            id="default-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" id="default_name"
                                        class="form-control" placeholder="{{ translate('messages.company_name') }}"
                                        required>
                                </div>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <textarea type="text" name="address[]" placeholder="{{translate('messages.company')}}" class="form-control min-h-90px ckeditor"></textarea>
                                </div>
                            </div>
                                @foreach (json_decode($language) as $lang)
                                    <div class="d-none lang_form"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name[]" id="{{ $lang }}_name"
                                                class="form-control" placeholder="{{ translate('messages.courier_company_name') }}">
                                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap flex-sm-nowrap __gap-12px">
                                ...
                                <label class="__custom-upload-img">
                                    ...
                                    @php($icon = $icon->value ?? '')
                                    <label class="form-label">
                                        {{ translate('Company Cover') }}  <span class="text--primary">({{ translate('2:1') }})</span>
                                    </label>
                                    <div class="text-center">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center">
                                ...
                                <span>{{translate('Courier Company information')}}</span>
                            </h4>
                        </div>
                        <div class="card-body">

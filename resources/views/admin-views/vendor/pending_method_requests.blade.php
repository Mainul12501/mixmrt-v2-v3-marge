            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tr>
                        ...
                        <th class="text-uppercase border-0">{{translate('messages.Action')}}</th>
                    </tr>
                    </thead>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn--container">
                                    <a class="btn action-btn btn--primary btn-outline-primary float-right mr-2 request_alert" data-toggle="tooltip" data-placement="top" data-original-title="Approve" data-url="{{ route('admin.accept-dis-wid-met', ['id' => $disbursementWithdrawlMethod->id]) }}" data-message="You want to approve this application" href="javascript:"><i class="tio-done font-weight-bold"></i></a>
{{--                                    <a class="btn action-btn btn--danger btn-outline-danger float-right " data-toggle="tooltip" data-placement="top" data-original-title="Deny" data-url="" data-message="You want to deny this application" href="javascript:"><i class="tio-clear font-weight-bold"></i></a>--}}
                                    <form action="{{ route('admin.delete-dis-wid-met', ['id' => $disbursementWithdrawlMethod->id]) }}" method="post">
                                        @csrf

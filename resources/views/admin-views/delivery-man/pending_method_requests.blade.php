...
{{--                        <th class="border-0">{{translate('messages.Owner Information')}}</th>--}}
                        ...
                        <th class="text-uppercase border-0">{{translate('messages.actions')}}</th>
                    </tr>
                    </thead>
...
{{--                            </td>--}}
                            ...
                            <td>
                                <div class="btn--container">
                                    <a class="btn action-btn btn--primary btn-outline-primary float-right mr-2 request_alert" data-toggle="tooltip" data-placement="top" data-original-title="Approve" data-url="{{ url('/admin/accept/'.$disbursementWithdrawlMethod->id.'?req_from=dm') }}" data-message="You want to approve this application" href="javascript:"><i class="tio-done font-weight-bold"></i></a>

                                    <form action="{{ url('/admin/delete-row/'.$disbursementWithdrawlMethod->id) }}" method="post">
                                        @csrf

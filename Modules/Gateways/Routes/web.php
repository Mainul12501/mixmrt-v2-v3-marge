...
use Modules\Gateways\Http\Controllers\LencoPayController;
...
if ($is_published) {
    Route::group(['prefix' => 'payment'], function () {
        ...
        Route::group(['prefix' => 'lenco', 'as' => 'lenco.'], function () {
            Route::get('pay', [LencoPayController::class, 'payment'])->name('pay');
            Route::any('cancel', [LencoPayController::class, 'cancel'])->name('cancel')
            ->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
            Route::any('callback', [LencoPayController::class, 'callback'])->name('callback')
            ->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
        });

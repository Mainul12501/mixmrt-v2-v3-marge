...
class SMSConfigController extends Controller
{
    ...
    {
        $validation = [
            'gateway' => 'required|in:releans,twilio,nexmo,2factor,msg91,hubtel,paradox,signal_wire,019_sms,viatech,global_sms,akandit_sms,sms_to,alphanet_sms,engicell',
        ...
        }elseif ($request['gateway'] == 'engicell') {
            $additional_data = [
                'status' => 'required|in:1,0',
                'otp_template' => 'required',
                'api_key' => 'required',
        ...
        if ($request['status'] == 1) {
            foreach (['releans', 'twilio', 'nexmo', '2factor', 'msg91', 'hubtel', 'paradox', 'signal_wire', '019_sms', 'viatech', 'global_sms', 'akandit_sms', 'sms_to', 'alphanet_sms','engicell'] as $gateway) {
